...
export const TaskList: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleBankWalletChanged = () => {
      fetchTasks();
    };

    window.addEventListener('storage', handleStorageChange);
    window.addEventListener('bankWalletChanged', handleBankWalletChanged);

    return () => {
      window.removeEventListener('storage', handleStorageChange);
      window.removeEventListener('bankWalletChanged', handleBankWalletChanged);
    };
  }, []);
