...
export const BankWalletModal: React.FC = () => {
  ...
  const generateWallet = async () => {
    ...
    // Reuse the existing local-Hardhat funding flow from FHE-Frontend.
    // Hardhat exposes this default development account without placing a
    // private key in the frontend source.
    ...
    // Do not expose the wallet to the registration flow until it has funds.
    await tx.wait();
    ...
    messageApi.success('新银行钱包生成成功，已获得 10 ETH 测试资金！');
  };
